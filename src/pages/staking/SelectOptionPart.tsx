...
export default function SectionOptionPart() {
  return (
    <div className="w-[500px] py-[20px] px-[30px] border-2 rounded-[15px] space-y-5">
      ...
      <div className="flex justify-between font-['nasalization'] text-[14px]">
        <div>BANA Value</div>
        <div>Balance:0</div>
      </div>
      <div className="border border-secondary w-full rounded-[10px] px-[10px] py- flex justify-between items-center font-['nasalization'] ">
        <div className="text-[38px]">0.0</div>
        <LogoIcon size="40px" />
      </div>
      <div className="w-full grid grid-cols-4 space-x-3 text-[15px] font-['nasalization']">
        <div className="h-[30px] border border-secondary rounded-[12px] flex justify-center items-center">
          25%
        </div>
        <div className="h-[30px] border border-secondary rounded-[12px] flex justify-center items-center">
          50%
